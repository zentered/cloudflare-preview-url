...
;(() => {
  ...
  /* harmony default export */ const URLSearchParams =
    external_url_.URLSearchParams // CONCATENATED MODULE: ./node_modules/axios/lib/platform/node/index.js
  ...
  const external_zlib_namespaceObject = __WEBPACK_EXTERNAL_createRequire(
    import.meta.url
  )('zlib') // CONCATENATED MODULE: ./node_modules/axios/lib/env/data.js
  const VERSION = '1.3.1' // CONCATENATED MODULE: ./node_modules/axios/lib/helpers/parseProtocol.js
  ...
  /* harmony default export */ const helpers_ZlibHeaderTransformStream =
    ZlibHeaderTransformStream // CONCATENATED MODULE: ./node_modules/axios/lib/adapters/http.js
  ...
  /* harmony default export */ const http =
    ...
    function httpAdapter(config) {
      ...
      return new Promise(async function dispatchHttpRequest(
        resolvePromise,
        rejectPromise
      ) {
        ...
        if (utils.isSpecCompliantForm(data)) {
          ...
          if (!headers.hasContentLength()) {
            try {
              const knownLength = await external_util_
  ...
  /* harmony default export */ const lib_axios = axios // CONCATENATED MODULE: ./cloudflare.js
